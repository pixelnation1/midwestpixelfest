...
export const SPONSOR_REVIEW_FILTERS = [
  ...
  { id: "invoice_sent", label: "Invoice Sent", statuses: ["invoice_sent"] },
  { id: "awaiting_payment", label: "Awaiting Payment", statuses: ["invoice_created", "invoice_sent"] },
  { id: "paid", label: "Paid", statuses: ["paid", "assets_received"] },
  { id: "assets_needed", label: "Assets Needed", statuses: ["assets_needed"] },
